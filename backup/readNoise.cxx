...
void fitProfile(TProfile* myProfile, int& fedKey)
{
  ...
  for (unsigned int iApv=0; iApv<2; ++iApv) {
    ...
    //FIXME -- disactivated this, keep it ?
...
{
  cout << "Processing run " << runnum << ", corresponding to a bias voltage of " << mapVoltsToRunId[runnum] << endl;
  ...
  TString noisefile = "root://eoscms//eos/cms/store/group/dpg_tracker_strip/comm_tracker/Strip/RadMonitoring/NoiseBiasScan/2017/VRRandom0/crab_NoiseScan_20170919_run303272_v1/171130_125904/0000/SiStripCommissioningSource_1.root";
...
int main()
{
  ...
  cout << "Starting 'readNoise.exe'" <<endl;
