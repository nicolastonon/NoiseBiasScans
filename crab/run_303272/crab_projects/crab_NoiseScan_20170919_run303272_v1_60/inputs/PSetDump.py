...
process.source = cms.Source("PoolSource",
    eventsToProcess = cms.untracked.VEventRange("303272:300288-303272:320230"),
...
process.CommissioningHistos = cms.EDAnalyzer("SiStripCommissioningSource",
    ...
    PedsFullNoiseParameters = cms.PSet(
        ...
        UseAverageCommonMode = cms.bool(True),
        UseFloatPedestals = cms.bool(True)
    ),
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('92X_dataRun2_v5'),
